...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.0788}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.9212}}@{}}
...
\hypertarget{famous-blow-ups-in-delta-hedging-operations}{%
\subsection{Famous Blow-Ups in Delta-Hedging Operations}\label{famous-blow-ups-in-delta-hedging-operations}}
...
\tightlist
\item
  \href{https://volquant.medium.com/epic-failures-lessons-from-volatility-funds-blow-ups-6f4226c8334f}{``Epic Failures - Lessons from Volatility Funds Blow-Ups.'' Harel Jacobson}
\item
  \href{https://www.ft.com/content/b8ddbf92-c9b4-4a81-a167-ef9ee80962a5}{``Turbulent Markets Upend Volatility Hedge Funds.'' Laurence Fletcher and Richard Hendarson, FT.}
\item
  \href{https://www.institutionalinvestor.com/article/b1m6kkzscgqrl0/How-to-Lose-a-Billion-Dollars-Without-Really-Trying}{``How to Lose a Billion Dollars Without Really Trying.'' Leanna Orr. Institutional Investor.}
\end{enumerate}
...
\includegraphics{11-PriceReactionto_files/figure-latex/unnamed-chunk-1-1.pdf}
...
\includegraphics{11-PriceReactionto_files/figure-latex/unnamed-chunk-2-1.pdf}
...
\includegraphics{11-PriceReactionto_files/figure-latex/unnamed-chunk-3-1.pdf}
...
the operations of meat packers and live poultry dealers. Source: \href{http://www.gipsa.usda.gov/about/mission.aspx}{USDA
GIPSA}
\end{quote}
...
\href{http://www.gipsa.usda.gov/fgis/public_reports.aspx}{useful statistics}
...
\includegraphics{16-TheSoybeanCrush_files/figure-latex/unnamed-chunk-1-1.pdf}
...
\includegraphics{20-CrudeOiland_files/figure-latex/unnamed-chunk-1-1.pdf}
