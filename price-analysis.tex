...
\section{Recent Trends in Acreage, Yield, Production, and Use}\label{recent-trends-in-acreage-yield-production-and-use-2}}
...
\subsection{Trasformation Over Space, Time, and Form}\label{trasformation-over-space-time-and-form}}
...
\subsection{Forecasting Commodity Prices in Business}\label{forecasting-commodity-prices-in-business}}
...
\subsection{Price Analysis versus Forecasting}\label{price-analysis-versus-forecasting}}
...
\item
  ...
  \item
    Also known as \href{https://en.wikipedia.org/wiki/Occam\%27s_razor}{Occam's Razor}
  \end{itemize}

  \begin{quote}
  The Principle States that among competing hypotheses that predict equally well, the one with the fewest assumptions should be selected. Other, more complicated solutions may ultimately prove to provide better predictions, but - in the absence of differences in predictive ability - the fewer assumptions that are made, the better. (Source: \href{https://en.wikipedia.org/wiki/Occam\%27s_razor}{Wikipedia})
  \end{quote}
...
Figure 1. A Grain Elevator in Royal, IL \href{https://commons.wikimedia.org/wiki/File\%3AGrain_elevators_in_Royal\%2C_IL.jpg}{\includegraphics[width=5.33333in,height=\textheight]{https://upload.wikimedia.org/wikipedia/commons/thumb/0/01/Grain_elevators_in_Royal\%252C_IL.jpg/512px-Grain_elevators_in_Royal\%252C_IL.jpg}}
...
\includegraphics{05-PricesSpaceTime_files/figure-latex/unnamed-chunk-1-1.pdf}
...
\includegraphics{05-PricesSpaceTime_files/figure-latex/unnamed-chunk-2-1.pdf}
...
\begin{description}
\item[\href{http://farmdocdaily.illinois.edu/2015/02/balance-sheet-projections-for-2015-16-corn-marketing-year.html}{Balance Sheet Projections for the 2015-16 Corn Marketing Year}]
This \emph{farmdoc daily} article was written in February of 2015. This is well before spring planting of corn and soybeans in the United States. However, farmers during this time are actively planning for planting season - prepping equipment, fertilizing and preparing ground, and buying seed. Good lays out the groundwork for early forecasts of the 2015/2016 marketing year balance sheet. This article is published two days before the February 2015 WASDE report, and Good provides context upon which market expectations for the WASDE report can be based upon.

Good, D. ``\href{http://farmdocdaily.illinois.edu/2015/02/balance-sheet-projections-for-2015-16-corn-marketing-year.html}{Balance Sheet Projections for the 2015-16 Corn Marketing Year}.'' \emph{farmdoc daily} (5):23, Department of Agricultural and Consumer Economics, University of Illinois at Urbana-Champaign, February 9, 2015.
\item[\href{http://farmdocdaily.illinois.edu/2015/04/projecting-2015-16-corn-balance-sheet.html}{Projecting the 2015-16 Corn Balance Sheet and Price Implications}]
...
Good, D., and S. Irwin. ``\href{http://farmdocdaily.illinois.edu/2015/04/projecting-2015-16-corn-balance-sheet.html}{Projecting the 2015-16 Corn Balance Sheet and Price Implications}.'' \emph{farmdoc daily} (5):70, Department of Agricultural and Consumer Economics, University of Illinois at Urbana-Champaign, April 16, 2015.
\end{description}
...
\section{History - ``The Great Data Leak of 1905''}\label{history---the-great-data-leak-of-1905}}
...
\caption{Figure 1: Safeguarding America's Agricultural Statistics: A century of Successful and Secure Procedures}
\end{figure}

Source: \href{pdf-Readings/safegaurding-americas-agricultural-statistics.pdf}{NASS: About Nass}
...
\hypertarget{some-examples-of-recent-big-market-reactions}{%
\subsection{Some Examples of Recent Big Market Reactions}\label{some-examples-of-recent-big-market-reactions}}

Using the Best Bid Best Offer database from the CME Group's \href{http://www.cmegroup.com/market-data/datamine-historical-data/}{DataMine} we can examine historical intraday transaction prices (like what is available streaming in real-time from Yahoo Finance or other sources). These data are time-stamped to the second and allow the most accurate and fine scale picture of futures market trading tick-by-tick.
...
\begin{figure}
\centering
\includegraphics{images/8_wasdeprod_snip.png}
...
\begin{figure}
\centering
\includegraphics{Excel-files/c-s2017_files/image001.png}
...
\includegraphics{Excel-files/ForecastingProduction-HistoricalAcreage_files/image015.png}
...
\begin{figure}
\centering
\includegraphics{Excel-files/ForecastingProduction-HistoricalAcreage_files/image033.png}
...
\includegraphics{12-A-South-American-Production_files/figure-latex/unnamed-chunk-1-1.pdf}
...
\includegraphics{12-A-South-American-Production_files/figure-latex/unnamed-chunk-2-1.pdf}
...
\includegraphics{12-A-South-American-Production_files/figure-latex/unnamed-chunk-4-1.pdf}
...
\includegraphics{12-A-South-American-Production_files/figure-latex/unnamed-chunk-5-1.pdf}
...
\begin{figure}
\centering
\includegraphics{images/brazil-soybeans-1.png}
...
\begin{figure}
\centering
\includegraphics{images/brazil-corn2-1.png}
...
\begin{figure}
\centering
\includegraphics{images/brazil-corn1-1.png}
...
\begin{figure}
\centering
\includegraphics{images/argentina-corn-1.png}
...
\begin{figure}
\centering
\includegraphics{images/argentina-soy-1.png}
\caption{Figure 10: Regional Argentinian Soybean Production Seasons}
\end{figure}

\begin{figure}
\centering
\includegraphics{images/argentina-production.png}
...
\begin{figure}
\centering
\includegraphics{images/bolsa.png}
...
\includegraphics{images/brazil-index-excel.png}
...
\includegraphics{images/soyoilmeal_checkoff.jpg}
...
\includegraphics{12-TheSoybeanCrush_files/figure-latex/unnamed-chunk-1-1.pdf}
...
\includegraphics{16-CrudeOiland_files/figure-latex/unnamed-chunk-1-1.pdf}
...
\begin{figure}
\centering
\includegraphics{images/cropprogress.png}
...
\begin{figure}
\centering
\includegraphics{Excel-files/yied-forecast-advanced_files/image001.png}
...
\begin{figure}
\centering
\includegraphics{images/ts-workflow.png}
