...
library(tidyverse)
grains   <- read.csv('assets/psd_grains_pulses.csv')
...
ggsave(filename = "SouthAmericanProduction_TopProdCorn.png")
...
ggsave(filename = "SouthAmericanProduction_TopExporterCorn.png")
...
ggsave(filename = "SouthAmericanProd_TopProdSoy.png")
...
ggsave(filename = "SouthAmericanProd_TopExporterSoy.png")
