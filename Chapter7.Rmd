...
![Figure 2: Corn Food, Alchohol, and Industrial Use, Annual 1990-2015](FeedGrains_Corn_files\image013.png)
...
library(Kmisc)
library(knitr)
corn_importers <- read.csv('corn_importers.csv', header = TRUE)
