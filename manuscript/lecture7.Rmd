...
The most useful technique to quickly spot data encoding errors is to plot the data. Its a pretty low-tech technique, but when there is an error, this can be the most efficient way to spot it. 

# Data Cleaning 

Table 4 below reproduces table 3, but with on encoding error. Can you spot it?
