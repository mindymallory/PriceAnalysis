...
1. replace balance sheet tables with actual usda forecast tables uploaded by .csv
2. write a little something in the how to come up with a price section. 
...
The intuition here is simply that before planting, the final supply for the crop can be afected by farmers changing their intentions about how many acres to plant. Once the crop has been planted, supply is essentially fixed, execpt for the uncertainty that remains due to realized yeilds. To summarize, things that affect the supply of a commodity are outlined below. 
