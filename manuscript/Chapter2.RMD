---
title: "Chapter 2: How to Find Information about Commodity Markets"
output:  
    html_document:
        toc: true
        fig_caption: yes
...
| SRS Wheat  | W         |March (H), May (K), July (N), September (U), December (Z) | WZ15, December 2015 SRW Wheat|  [WZ15.cbt](http://finance.yahoo.com/q;_ylt=Ajq44ku8k3rd1HzDOLpIozEnv7gF?uhb=uhb2&fr=uh3_finance_vert_gs&type=2button&s=wz15.cbt) | [CME/WZ2015](https://www.quandl.com/data/CME/WZ2015-Wheat-Futures-December-2015-WZ2015) |
...
2. Calculate the difference between the December price and the March price in excel. This difference is called the spread. Sometimes you will hear it referred to as the Dec/March spread or the z/h spread - only making reference to the contract month codes. Convention dictates that the nearest to expire contract is the first in the difference; i.e., `December - March` rather than `March - December`.
    ...
    + Can you think of any statisticts you could calculate to back up your intuition?
