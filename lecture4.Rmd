...
author: "Instructor: Mindy L. Mallory,  TA: Quanbiao Shang"
output: ioslides
theme: uulm
---
...
- Some of the USDA reports contain very sensitive market information causing market prices to adjust rapidly to new information about supply and demand. 
- Access to the contents of a market sensitive report would result in the ability to perform 'insider trading' and obtain nearly risk-less profits. 
- This activity is illegal, and the USDA's NASS prepares the reports under lock-down conditions where during the process of finalizing estimates of the report's content, officials are locked in a secure area and not allowed to leave until the report is made known to the public. 
...
# Tomorrow, September 11 WASDE Report Released 

[WASDE Report](http://www.usda.gov/oce/commodity/wasde/)

**Assignment 2**

Comment on the results from the September WASDE report for corn and soybeans. Note any categories that experienced unexpected changes. Note the following categories as particularly important: Yield, Harvested Acres (and thus production), and exports. 

Obtain the WASDE in excel format from the USDA website above. Copy and paste the corn table and the soybean table into your assignment document (probably a Microsoft Word document). 

**Due Monday Sept 14, at 11:30pm**

Note that in your final group projects you are required to forecast the November WASDE report. This assignment will get you accustomed to obtaining the WASDE report, examining its contents, and digest its contents. The exercise will make your Group Final Projects go more smoothly. 
