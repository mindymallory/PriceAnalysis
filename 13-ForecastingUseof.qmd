...
[Interested in more? Please let me know by]{style="color:red"} [taking
the survey](https://forms.gle/Q3VByCQZHjfQSy9D7)!
...
$\begin{aligned} Feed\&Residual = (Production + \epsilon_{prod}) + (Imports + \epsilon_{import}) + (Beginning Stocks + \epsilon_{BStocks}) \\ - (Ending Stocks + \epsilon_{EStocks}) - (FoodSeed\&Industrial + \epsilon_{Food}) - (Exports + \epsilon_{Export}) \end{aligned}$
...
20,000 tons and 40,000 tons, respectively. \> \### Weekly Reports Weekly
reports are also required, regardless of the size of the sales
