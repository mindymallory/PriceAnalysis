...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{assets/map_CORN_AREA PLANTED.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{assets/PrimerforGrain_CornAcandY.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{assets/PrimerforGrain_CornProdand$.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{assets/PrimerforGrain_CornUse.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{assets/map_SOYBEANS_AREA PLANTED.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{assets/PrimerforGrain_SoyAcandY.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{assets/PrimerforGrain_SoyProdand$.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{assets/PrimerforGrain_SoyUse.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/Wheat-Growing-Areas.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/HRW-Wheat.jpg}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/HRS-Wheat.jpg}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/SRW-Wheat.jpg}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{assets/PrimerforGrain_WheatAcandY.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{assets/PrimerforGrain_WheatProdand$.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{assets/PrimerforGrain_CornPrices.png}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.1745}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.0622}}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.9378}}@{}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.1704}}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.8296}}@{}}
...
\href{https://commons.wikimedia.org/wiki/File:Grain_elevators_in_Royal,_IL.}{\pandocbounded{\includegraphics[keepaspectratio]{assets/Grain_elevator_royal_IL.jpg}}}
...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1721}}
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2787}}
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2049}}
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2213}}
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1230}}@{}}
\toprule\noalign{}
...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.0827}}
  >{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.2105}}
  >{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1805}}
  >{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.2556}}
  >{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.0602}}
  >{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.0677}}
  >{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.0677}}
  >{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.0752}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\centering
Dates
\end{minipage} & \begin{minipage}[b]{\linewidth}\centering
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/Options1-optionplot.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/Options1-optionintrinsic.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/Options1-undelyingquote.PNG}}

\begin{figure}[H]

{\centering \pandocbounded{\includegraphics[keepaspectratio]{assets/Options1-quotes.PNG}}
...
case of the call options, the prices are decreasing as you move down the
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/Options1-optionmoneynessplot.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/Options2-volcluster.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/Options2-deltahedge.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/Options4-spot.png}}

Next, add the payoff at expiration of a long 450 strike put option whose
premium is 17 cents per bushel.

\pandocbounded{\includegraphics[keepaspectratio]{assets/Options4-spotput.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/Options4-spotputcomb.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/Options4-spotputcombzoom.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/Options4-spotputcombzoomchoice.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/Options4-spotfence.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/Options4-Netspotfence.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/cropins_ex.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/PricesSpaceTime-increasing-9-26-2016.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/PricesSpaceTime-increasing-9-25-2015.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/PricesSpaceTime-decreasing-4-13-2012.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/PricesSpaceTime-flat-8-01-2012.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/PricesSpaceTime-flat-12-03-2012.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/PricesSpaceTime-pricesincreasing-hyp.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/PricesSpaceTime-pricesdecreasing-hyp.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/IL-River.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/Burns-Harbor.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/Champaign-Elevators.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/Ch3.1.png}}
...
\begin{verbatim}
Response [https://esmis.nal.usda.gov/sites/default/release-files/3t945q76s/dv140m16d/jm215h19t/latest.xls]
  Date: 2025-10-27 19:15
  Status: 200
  Content-Type: application/vnd.ms-excel
  Size: 326 kB
<ON DISK>  C:\Users\mindy\AppData\Local\Temp\RtmpkZAUEp\file231cd5022cd.xls
\end{verbatim}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/NASS_History.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/NASS_release_timeline.png}}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.0943}}
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.7484}}@{}}
...
\pandocbounded{\includegraphics[keepaspectratio]{11-PriceReactionto_files/figure-pdf/unnamed-chunk-1-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{11-PriceReactionto_files/figure-pdf/unnamed-chunk-2-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{11-PriceReactionto_files/figure-pdf/unnamed-chunk-3-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{12-ForecastingProduction_files/figure-pdf/unnamed-chunk-1-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{12-ForecastingProduction_files/figure-pdf/unnamed-chunk-2-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{12-ForecastingProduction_files/figure-pdf/unnamed-chunk-3-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/ForecastingUseof-CornUseCategories.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/ForecastingUseof-CornUseCategoriesFoodAlcoholInd.png}}
Source:
\href{http://www.ers.usda.gov/data-products/feed-grains-database/feed-grains-yearbook-tables.aspx\#26780}{Feed
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/ForecastingUseof-CornUseCategoriesFoodAlcoholIndMY.png}}
Source:
\href{http://www.ers.usda.gov/data-products/feed-grains-database/feed-grains-yearbook-tables.aspx\#26780}{Feed
Grains database} maintained by the USDA ERS.
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/ForecastingUseof-CornUseCategoriesFoodAlcoholIndPropofUse.png}}
Source:
\href{http://www.ers.usda.gov/data-products/feed-grains-database/feed-grains-yearbook-tables.aspx\#26780}{Feed
Grains database} maintained by the USDA ERS.
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/ForecastingUseof-CornUseCategoriesExports.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/ForecastingUseof-ExportsMY.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/ForecastingUseof-CornUseCategoriesExportsPropofUse.png}}
Source:
\href{http://www.ers.usda.gov/data-products/feed-grains-database/feed-grains-yearbook-tables.aspx\#26780}{Feed
Grains database} maintained by the USDA ERS.
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.0500}}
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1800}}
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.0500}}
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1800}}
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.0500}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/ForecastingUseof-CornUseCategoriesFeedResid.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/ForecastingUseof-FeedandResidualMY.png}}

Source:
\href{http://www.ers.usda.gov/data-products/feed-grains-database/feed-grains-yearbook-tables.aspx\#26780}{Feed
Grains database} maintained by the USDA ERS.

\pandocbounded{\includegraphics[keepaspectratio]{assets/ForecastingUseof-CornUseCategoriesFeedandResidPropofUse.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/ForecastingUseof-Ethanol.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Excel-files/ForecastingUseSoy-OilCropsYearbook_files/image013.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Excel-files/ForecastingUseSoy-OilCropsYearbook_files/image005.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Excel-files/ForecastingUseSoy-OilCropsYearbook_files/image007.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Excel-files/ForecastingUseSoy-OilCropsYearbook_files/image001.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Excel-files/ForecastingUseSoy-OilCropsYearbook_files/image009.png}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.0891}}
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1782}}
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.0495}}
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1782}}
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.0495}}
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1782}}
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.0495}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Excel-files/ForecastingUseSoy-OilCropsYearbook_files/image003.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Excel-files/ForecastingUseSoy-OilCropsYearbook_files/image012.png}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1627}}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1506}}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1807}}
  >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2470}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/fdd04092015_fig1.jpg}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{assets/EndingStocksand-StocksUsePrices.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{assets/EndingStocksand-StocksUsePrices2.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{assets/EndingStocksand-StocksUsePrices3.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/soyoilmeal_checkoff.jpg}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/soyflakes.jpg}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/soymeal.jpg}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/crush_products.jpg}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/hydrogenated_oil.jpg}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/pigs.jpg}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/poultry.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/SoyCrushSpread.png}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.3670}}
  >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.0642}}
  >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.0642}}
  >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.0642}}
  >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.0550}}
  >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.3853}}@{}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/eth_locations.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/640px-Ethanol_plant.jpg}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{assets/CornDDGPrices.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{assets/DDGCORNRatio.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{assets/EthRBOB.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/ECrushSpread.png}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.2240}}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.7760}}@{}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/hogstates.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/hogprodvaluecounty.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/numberproducersshare.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/numberoperations.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/top_5_petroleum_states-large.jpg}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/Brent_crude_oil_map (1).png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/top_petroleum_producing_countries-large.jpg}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/products_from_barrel_crude_oil-large.jpg}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Excel-files/CrudeOiland-crudeoil_files/image003.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Excel-files/CrudeOiland-crudeoil_files/image008.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Excel-files/CrudeOiland-crudeoil_files/image004.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/640px-Bakken_Wells_2008.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/Bakken_Wells_2013.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Excel-files/CrudeOiland-crudeoil_files/image007.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{20-CrudeOiland_files/figure-pdf/unnamed-chunk-1-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/cropprogress.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Excel-files/yied-forecast-advanced_files/image001.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Excel-files/IntroductiontoCommodityTS-Nearby_construct_files/image005.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Excel-files/IntroductiontoCommodityTS-Nearby_construct_files/image001.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Excel-files/IntroductiontoCommodityTS-FeedGrains_Corn_files/image010.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/dallasfednominal_c1.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Excel-files/IntroductiontoCommodityTS-FeedGrains_Corn_files/image026.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Excel-files/IntroductiontoCommodityTS-random_walk_files/image003.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Excel-files/IntroductiontoCommodityTS-random_walk_files/image001.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Excel-files/IntroductiontoCommodityTS-random_walk_files/image007.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Excel-files/IntroductiontoCommodityTS-random_walk_files/image005.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Excel-files/IntroductiontoCommodityTS-Nearby_construct_files/image002.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/ts-workflow.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/12_corn_h2016.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/12.lags.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/12_corn_autocorrel.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/12_corn_ar2_output.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/12_solvermaq.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/12_ma2.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/12_forecast_screenshot.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/12_forecast_plot.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/SouthAmericanProduction_TopProdCorn.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/SouthAmericanProduction_TopExporterCorn.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/SouthAmericanProd_TopProdSoy.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{assets/SouthAmericanProd_TopExporterSoy.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{assets/Brazilcalendar.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{assets/Brazil_Soybean.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{assets/Brazil_SecondSeason_Corn.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{assets/Brazil_FirstSeason_Corn.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{assets/Argentina_Departments_Corn.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{assets/Argentina_Departments_Soybean.png}}
