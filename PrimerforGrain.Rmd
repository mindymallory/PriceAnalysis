---
title: "Primer for Grain and Oilseed Markets"
output:  
    html_document:
        toc: true
        fig_caption: yes
...
This chapter will introduce the basic production processes and timeline for major grains and oilseeds: Corn, Soybeans, Hard Red Winter Wheat (KC wheat), Hard Red Spring Wheat (Minneapolis wheat), and Soft Red Winter Wheat. 
...
Corn prices can be quite volative, with prices and production highly inversely related to one another. 
...
Soybeans consumed in the U.S. are almost exclusively processed into soybean meal and soybean oil, a process referred to as 'crushing'. Soybean meal is high in protien and used as an ingredient in livestock feed. Soybean oil is used for a variety of things, but the bulk of it is consumed as edible oil. 

About half of the soybeans produced in the U.S. are exported. 
