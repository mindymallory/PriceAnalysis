...
![Corn Prices Recieved](images\Ch1_PricesRecieved_files\image001.png)
Source([http://www.nass.usda.gov/](http://www.nass.usda.gov/))

# Long Term Agricultural Price Trends
Now lets zoom in on the 1974-2015 periods. 

![Corn Prices Recieved](images\Ch1_PricesRecieved_files\image003.png)
Source([http://www.nass.usda.gov/](http://www.nass.usda.gov/))
...
# Current Agricultural Price Trends


# What is a Commodity

- A commodity is a good that can be supplied without qualitative differences. A bushel of wheat is regarded as a bushel of wheat everywhere.
...
- Studying a commodity's transformation over space comes about from the fact that the production of a commodity is often concentrated in a specific geographic location, while consumption of commodities is usually dispersed
    - Price differentials need to provide incentives to move from one location to another

# Trasformation Over Space, Time, and Form
- Studying a commodity's transformation through time considers the nature of prices required to provide incentive to store the commodity for use at a later date
    - Price differentials need to provide incentive to store or bring product to market, whichever is needed

# Trasformation Over Space, Time, and Form    
- Commodities can be transformed into completely different goods. 
    - Sometimes this transformation creates new commodities; for example soybeans are crushed into soybean oil and soybean meal
    - both of which are considered commodities. 
    
- Other times the transformation creates products that are no longer considered commodities, where quality and differentiation matters. 
    - Meat products are a good example of this.
    - Green coffee beans are considered a commodity, but once they enter the supply chain companies start transforming it by roasting, grinding, and brewing the coffee.
...
- With storable commodities, prices in one period must be related to prices in another period because those holding stocks of the commodity will constantly calculating their expectation of when best to sell - now or later. 
- With non-storable commodities, prices can only be affected by the current supply of the commodity, since past supply cannot be brought forward. 
